...
allClearBtn = Button(buttonFrame, text="AC", font=font, width=11, relief="flat", bg="gray88", activebackground="gray70",
                     activeforeground="white",
                     command=all_clear)
allClearBtn.grid(row=0, column=0, columnspan=2, padx=3, pady=3)

clearBtn = Button(buttonFrame, text="Del", font=font, width=11, relief="flat", bg="gray88", activebackground="gray70",
                  activeforeground="white",
                  command=clear)
...
for i in range(1, 4):
    for j in range(0, 3):
        btn = Button(buttonFrame, text=str(temp), font=font, width=5, relief="flat", bg="gray88",
                     activebackground="gray70", activeforeground="white")
        btn.grid(row=i, column=j, padx=3, pady=3)
        btn.bind("<Button-1>", click_btn_function)
        temp -= 1

zeroBtn = Button(buttonFrame, text="0", font=font, width=5, relief="flat", bg="gray88", activebackground="gray70",
                 activeforeground="white")
zeroBtn.grid(row=4, column=0, padx=3, pady=3)

dotBtn = Button(buttonFrame, text=".", font=font, width=5, relief="flat", bg="gray88", activebackground="gray70",
                activeforeground="white")
dotBtn.grid(row=4, column=1, padx=3, pady=3)

equalBtn = Button(buttonFrame, text="=", font=font, width=5, relief="flat", bg="gray88", activebackground="gray70",
                  activeforeground="white")
equalBtn.grid(row=4, column=2, padx=3, pady=3)

plusBtn = Button(buttonFrame, text="+", font=font, width=5, relief="flat", bg="gray88", activebackground="gray70",
                 activeforeground="white")
plusBtn.grid(row=1, column=3, padx=3, pady=3)

minusBtn = Button(buttonFrame, text="-", font=font, width=5, relief="flat", bg="gray88", activebackground="gray70",
                  activeforeground="white")
minusBtn.grid(row=2, column=3, padx=3, pady=3)

multBtn = Button(buttonFrame, text="x", font=font, width=5, relief="flat", bg="gray88", activebackground="gray70",
                 activeforeground="white")
multBtn.grid(row=3, column=3, padx=3, pady=3)

divBtn = Button(buttonFrame, text="/", font=font, width=5, relief="flat", bg="gray88", activebackground="gray70",
                activeforeground="white")
...
lbracBtn = Button(topFrame, text="(", font=scfont, width=5, relief="flat", bg="olivedrab2", activebackground="gray70",
                  activeforeground="white")
lbracBtn.grid(row=0, column=0, padx=3, pady=3)

rbracBtn = Button(topFrame, text=")", font=scfont, width=5, relief="flat", bg="olivedrab2", activebackground="gray70",
                  activeforeground="white")
rbracBtn.grid(row=0, column=1, padx=3, pady=3)

sqBtn = Button(topFrame, text="x^2", font=scfont, width=5, relief="flat", bg="olivedrab2", activebackground="gray70",
               activeforeground="white")
sqBtn.grid(row=0, column=5, padx=3, pady=3)

sqrtBtn = Button(topFrame, text="√", font=scfont, width=5, relief="flat", bg="olivedrab2", activebackground="gray70",
                 activeforeground="white")
sqrtBtn.grid(row=0, column=6, padx=3, pady=3)

# *************************  Adding SC buttons in SC FRAME  *********************
powBtn = Button(scFrame, text="x^y", font=scfont, width=5, relief="flat", bg="olivedrab2", activebackground="gray70",
                activeforeground="white")
powBtn.grid(row=1, column=0, padx=3, pady=3)

factBtn = Button(scFrame, text="x!", font=scfont, width=5, relief="flat", bg="olivedrab2", activebackground="gray70",
                 activeforeground="white")
factBtn.grid(row=1, column=1, padx=3, pady=3)

radBtn = Button(topFrame, text="ToRad", font=scfont, width=5, relief="flat", bg="olivedrab2", activebackground="gray70",
                activeforeground="white")
radBtn.grid(row=0, column=2, padx=3, pady=3)

degBtn = Button(topFrame, text="ToDeg", font=scfont, width=5, relief="flat", bg="olivedrab2", activebackground="gray70",
                activeforeground="white")
degBtn.grid(row=0, column=3, padx=3, pady=3)

sinBtn = Button(scFrame, text="Sinϴ", font=scfont, width=5, relief="flat", bg="olivedrab2", activebackground="gray70",
                activeforeground="white")
sinBtn.grid(row=3, column=0, padx=3, pady=3)

sinhBtn = Button(scFrame, text="Sinhϴ", font=scfont, width=5, relief="flat", bg="olivedrab2", activebackground="gray70",
                 activeforeground="white")
sinhBtn.grid(row=3, column=1, padx=3, pady=3)

cosBtn = Button(scFrame, text="Cosϴ", font=scfont, width=5, relief="flat", bg="olivedrab2", activebackground="gray70",
                activeforeground="white")
cosBtn.grid(row=4, column=0, padx=3, pady=3)

coshBtn = Button(scFrame, text="Coshϴ", font=scfont, width=5, relief="flat", bg="olivedrab2", activebackground="gray70",
                 activeforeground="white")
coshBtn.grid(row=4, column=1, padx=3, pady=3)

tanBtn = Button(scFrame, text="Tanϴ", font=scfont, width=5, relief="flat", bg="olivedrab2", activebackground="gray70",
                activeforeground="white")
tanBtn.grid(row=5, column=0, padx=3, pady=3)

tanhBtn = Button(scFrame, text="Tanhϴ", font=scfont, width=5, relief="flat", bg="olivedrab2", activebackground="gray70",
                 activeforeground="white")
tanhBtn.grid(row=5, column=1, padx=3, pady=3)

logBtn = Button(scFrame, text="log(x)", font=scfont, width=5, relief="flat", bg="olivedrab2", activebackground="gray70",
                activeforeground="white")
logBtn.grid(row=6, column=0, padx=3, pady=3)

lgBtn = Button(scFrame, text="lg(x)", font=scfont, width=5, relief="flat", bg="olivedrab2", activebackground="gray70",
               activeforeground="white")
